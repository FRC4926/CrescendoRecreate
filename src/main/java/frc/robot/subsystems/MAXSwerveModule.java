...
public class MAXSwerveModule {
  ...
  private double m_turningSetpoint = 0;
   ...
   * Encoder.
   */
  public MAXSwerveModule(String name, int drivingCANId, int turningCANId, int encoderCANId, double chassisAngularOffset) {
    m_name = name;
    ...
    m_desiredState.angle = new Rotation2d(getAbsolutePositionEncoder());
  ...
  public double getAbsoluteVelocityEncoder()
  {
    return m_turningEncoder.getAbsolutePosition().getValueAsDouble()*2*Math.PI/60.0;
  }
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    SwerveModuleState optimizedDesiredState = SwerveModuleState.optimize(correctedDesiredState,
        new Rotation2d(getAbsolutePositionEncoder()));
