...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    m_turningMotor = new CANSparkMax(turnID, MotorType.kBrushless);
    ...
    m_driveEncoder.setPositionConversionFactor(2 * Math.PI * kWheelRadius/ kGearRatio);
    m_driveEncoder.setVelocityConversionFactor((2 * Math.PI * kWheelRadius/ kGearRatio)/60.0);
